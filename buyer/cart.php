...
if (isset($_POST['checkout'])) {
    ...
    if ($_POST['quantity'] > $prdct['stock']) {
        $stockerror[] = "Sorry, not enough stock!";
        $stockerrorm[] = "Sorry, not enough stock!";
    } else {
...
<body>
    ...
    <section id="cart-mobile">
        ...
        <!-- Alert -->
        <!-- Alert Error -->
        <?php if (isset($stockerrorm)) : ?>
        <?php foreach ($stockerrorm as $stockerrorm) : ?>

        <!-- Modal -->
        <div class="modal modalStock fade">
